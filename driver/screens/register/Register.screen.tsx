...
const RegisterScreen = () => {
  ...
  const validateForm = () => {
    ...
    const isValidRouteNumber =
      routeNumber.length <= 3 && /^[0-9]+$/.test(routeNumber);
    ...
    if (!isValidDriverNumber) {
      ...
      setFormError(
        "Password must contain at least one uppercase letter, one lowercase letter, one number, one symbol, and be at least 5 characters long!"
      );
    ...
    >
      ...
      >
        <View style={{ flex: 1, marginRight: 10 }}>
          <Text style={{ marginBottom: 5, color: "#333", fontWeight: "600" }}>
            Driver Number
          </Text>
          <TextInput
            style={{
            ...
            value={driverNumber}
            onChangeText={(text) =>
              setDriverNumber(text.replace(/[^0-9]/g, "").slice(0, 10))
            }
        ...
        <View style={{ flex: 1 }}>
          ...
          <TextInput
            ...
            onChangeText={(text) =>
              setConductorNumber(text.replace(/[^0-9]/g, "").slice(0, 10))
            }
            keyboardType="numeric"
          />
        </View>
      ...
      >
        ...
        <GestureHandlerRootView className="flex-1">
          <Text className="mb-1 text-gray-800 font-semibold">Seat Count</Text>
          <TouchableOpacity
            onPress={() => setModalVisible(true)}
            className="border border-gray-300 rounded-lg bg-white h-12 justify-center px-4"
          >
            <Text className="text-gray-700">
              {seatCount || "Select Seat Count"}
            </Text>
          </TouchableOpacity>
      ...
      >
        <View style={{ flex: 1, marginRight: 10 }}>
          ...
          <TextInput
            ...
            value={routeNumber}
            onChangeText={(text) =>
              setRouteNumber(text.replace(/[^0-9]/g, "").slice(0, 3))
            }
            keyboardType="numeric"
          />
        </View>
